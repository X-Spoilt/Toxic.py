...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Minhajbro                     \033[94m│".center(columns+15))

    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))

    print("│ \033[95mGitHub : https://github.com/Minhajbro \033[94m│".center(columns+9))

    print("│ \033[95mCoder  : Tawsif              \033[37mV3.0 \033[94m│".center(columns+15))
